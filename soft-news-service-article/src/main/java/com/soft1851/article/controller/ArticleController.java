...
public class ArticleController extends BaseController implements ArticleControllerApi {
    ...
    private List<AppUserVo> getPublisherList(Set<String> idSet) {
        String userServerUrlExecute = "http://www.softnews.com:8003/user/queryByIds?userIds=" + JsonUtil.objectToJson(idSet);
    ...
    public GraceResult readArticle(String articleId, HttpServletRequest request) {
        ...
        //设置针对当前用户ip的永久存在的key，存入到redis，表示该ip的用户已经阅读过了，无法累加
