 ...
 * @Description FansServiceImpl 实现类
 * @Date 2020/11/26
 * @Version 1.0
 **/
@Service
...
public class FansServiceImpl extends BaseService implements FansService {
    ...
    public void follow(String writerId, String fanId) {
        ...
        //保存作者和粉丝关联关系，字段穴余便于统计分析，并且只认成为第一次成为粉丝的数据
        Fans fan = new Fans();
        fan.setId(fanPkId);
        fan.setFanId(fanId);
    ...
    public List<RegionRatioVO> queryRegionRatioCounts(String writerId) {
        ...
        for (String r : REGIONS) {
            ...
            RegionRatioVO regionRatioV0 = new RegionRatioVO();
            regionRatioV0.setName(r);
            regionRatioV0.setValue(count);
            list.add(regionRatioV0);
        }
        return list;
    }
}
